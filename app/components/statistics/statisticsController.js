    ...
    $scope.formatProgression = function(){
        ...
        $scope.progression.forEach(function(kanji){
            ...
            if(found){
                ...
                if(kanji.type=="reading") formatedProgression.push({name:kanji.name, readingVal:kanji.value, writingVal:0});
                else if(kanji.type=="writing") formatedProgression.push({name:kanji.name, readingVal:0, writingVal:kanji.value});   
            }
        });
